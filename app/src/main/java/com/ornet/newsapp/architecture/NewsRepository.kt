...
import com.ornet.newsapp.retrofit.NewsApi
import com.ornet.newsapp.retrofit.NewsDataFromJson
import com.ornet.newsapp.retrofit.RetrofitHelper
...
class NewsRepository {
    ...
    fun getNewsApiCall(category: String?): MutableLiveData<List<NewsModel>> {
        ...
        val call = RetrofitHelper.getInstance().create(NewsApi::class.java)
            .getNews("in", category, "5a3e054de1834138a2fbc4a75ee69053")
